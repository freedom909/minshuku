// Create a test user and then test becomeHost mutation
  ...
  try {
    ...
    if (response.ok) {
      ...
      if (result.data && result.data.signUp) {
        const { userId, email, role } = result.data.signUp;
...
async function main() {
  console.log('🚀 Starting complete becomeHost test...');
  console.log('========================================');
